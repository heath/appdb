...
authenticate email password =
  statement (email, password) Statement.authenticateUser
...
register email password name phone =
  Transaction.transact (Transaction.register email password name phone)
...
markNotificationRead notificationId =
  statement notificationId Statement.markNotificationRead
